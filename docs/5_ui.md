...
- DaisyUI - для стилизации компонентов и создания пользовательского интерфейса
...
- Остальной вид страницы занимает окно с табами: статистика, графики, ресурсы, воркеры
